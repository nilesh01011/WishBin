...
var _require = require('moment'),
    min = _require.min; // SASS File


mix.sass('resources/CSS/style.scss', 'public/CSS'); // Copy Img and Video files

mix.copyDirectory('resources/img', 'public/img');
mix.copyDirectory('resources/video', 'public/video'); // All Javascripts files
