...
"use strict";
/*!**********************************************!*\
  !*** ./resources/JS/AdminProductsDetails.js ***!
  \**********************************************/
...
function proATC(setData) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/add-cartpage', setData).then(function (resp) {})["catch"](function (err) {
    console.log(err);
  });
}
...
function BuyProducts(setData) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/add-cartpage', setData).then(function (resp) {
    console.log(resp);
  })["catch"](function (err) {
    console.log(err);
  });
