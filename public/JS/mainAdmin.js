...
function AddToCart(getId) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/add-cartpage/", getId).then(function (resp) {})["catch"](function (err) {
    console.log(err);
  });
}
...
function deleteMsg(id) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/adminPage/messages', {
    msgId: id
  }).then(function (resp) {
    console.log(resp);
  })["catch"](function (err) {
