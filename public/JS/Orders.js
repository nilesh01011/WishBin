...
function cancleorderproduct(getItems) {
  axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]("/orderpageproductdelete/".concat(getItems), {
...
function trackOrder(orderID) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/ordertrack', orderID).then(function (resp) {
    console.log(resp);
  })["catch"](function (err) {
    console.log(err);
  });
