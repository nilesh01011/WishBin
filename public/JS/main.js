...
function searchDate(key) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/searchresult/".concat(key)).then(function (resp) {
    console.log(resp);
  })["catch"](function (err) {
    console.log(err);
  });
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmy_projects"] = self["webpackChunkmy_projects"] || [];
