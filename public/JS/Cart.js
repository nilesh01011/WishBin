...
(function () {
  ...
  Array.from(classname).forEach(function (element) {
    element.addEventListener('change', function () {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().patch("/update-product-cartpage/".concat(id), {
        qty: this.value,
        ItemsID: id
...
function deleteItems(getID) {
  axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]("/remove-cartpage/".concat(getID), {
    ItemsID: getID
  }).then(function (resp) {
    console.log(resp);
    window.location = '/cartpage';
...
function WishlistAdd(getID) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/wishlist-add', getID).then(function (resp) {
    console.log(resp);
  })["catch"](function (err) {
    console.log(err);
  });
