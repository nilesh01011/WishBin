...
function WishlistAdd(data) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/wishlist-add', data).then(function (resp) {
    console.log(resp);
  })["catch"](function (err) {
    console.log(err);
  });
...
function DeleteWishList(delItems) {
  axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]("/wishlist-delete/".concat(delItems), {
...
function proATC(getID, deleteProID) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/add-cartpage', getID).then(function (resp) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]("/wishlist-delete/".concat(deleteProID), {
